...
namespace EmailValidator.Controllers
{
    ...
    public class ValidationResult
    {
        ...
        public static IPAddress dnsServer = IPAddress.Parse("8.8.8.8");
        ...
        internal string ReplaceAndRemoveWhiteSpaceBefore(string email, string part, string newpart)
        {
        ...
        internal Dictionary<string, string> spellReplace = new Dictionary<string, string>()
        {
            { ". om",".com" },
            { "","" }
        };

        internal string FixCommon(string email)
        {
            if (email.Contains("@"))
            {
                var dp = email.Split('@');
            ...
            foreach (var td in topDomains)
            {
                ...
                if (isFixed)
                    break;
                /*else if (email.EndsWith(td))
                {
                    email = email.Substring(0, email.Length - td.Length) + "." + td;
                    break;
                }*/
            }
            return email;
