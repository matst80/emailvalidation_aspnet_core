...
.PARAMETER Clean
Removes the image emailvalidator and kills all containers based on that image.
...
Build a Docker image named emailvalidator
#>
...
$imageName="emailvalidator"
$projectName="emailvalidator"
